...
For example, instead of calling https://api.portasecura.com:4443/lightbulbs you should now call https://api.portasecura.com/lightbulbs-apikey
...
### Endpoints:
- API: https://api.portasecura.com:4443
